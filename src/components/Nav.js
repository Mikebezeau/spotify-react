...
import { BsHouseDoorFill, BsSearch, BsCollectionFill } from "react-icons/bs";
...
function Nav() {
  return (
    <div className="navBar">
        ...
        <ul>
            <li className="active"><BsHouseDoorFill/>Home</li>
            <li><BsSearch/>Search</li>
            <li><BsCollectionFill/>Your Library</li>
        </ul>
